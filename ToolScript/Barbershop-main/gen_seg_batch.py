...
if __name__=='__main__':
    ...
    imroot='/disks/disk1/Dataset/Project/SuperResolution/taobao_stand_face'
    dstroot='/disks/disk1/Dataset/Project/SuperResolution/taobao_stand_face_seg'
    ims=get_ims(imroot)
    ...
    for i,im in enumerate(ims):
        ...
        cv2.imwrite(os.path.join(dstroot,os.path.basename(im)),vis_mask)
