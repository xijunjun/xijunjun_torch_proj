...
parser.add_argument('-unprocessed_dir', type=str, default='/home/tao/disk1/Dataset/Project/barbershop/HDfaceCrop', help='directory with unprocessed images')
...
# f=open_url("/home/tao/Downloads/shape_predictor_68_face_landmarks.dat", cache_dir=cache_dir, return_path=True)
predictor = dlib.shape_predictor('/home/tao/Downloads/shape_predictor_68_face_landmarks.dat')
