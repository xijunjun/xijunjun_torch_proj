...
class L1Loss(nn.Module):
    ...
    def forward(self, landmark_gt, landmarks):
        ...
        return self.loss(landmark_gt, landmarks)
...
if __name__ == '__main__':
    ...
    max_epoch=1000
    save_freq=20
    checkpointdir='/home/tao/disk1/Workspace/TrainResult/hairrctseg'
    project_name='segbise_hairrct128-refine1'
...
# ]
    ...
    resume_checkpoint='/home/tao/disk1/Workspace/TrainResult/hairrctseg/segbise_hairrct128-refine0/plate_land_latest.pt'
